    ...
    <div className='frame w-full flex flex-col gap-5'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10'>
        {packages.map((item, index) => (
          <div
            key={index}
            className='w-full h-full flex flex-col items-center rounded-xl shadow-md border-2 bg-white border-green-600 duration-300 md:hover:shadow-xl md:hover:scale-95 md:hover:-skew-y-1 transform-gpu'
          >
