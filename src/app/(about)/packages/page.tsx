    ...
    <div className='frame w-full flex flex-col gap-5'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10'>
        {packages.map((item, index) => (
          <div
            key={index}
            className='w-full h-full flex flex-col items-center rounded-xl shadow-xl border-2 border-green-500 duration-300 hover:scale-95 hover:-skew-y-1 transform-gpu'
          >
