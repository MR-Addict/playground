...
export default function Welcome() {
  return (
    <div className='flex flex-col items-center gap-10 md:gap-20 py-10'>
      <h1 className='font-bold text-3xl text-center text-gray-700 italic'>Welcome to my Next.js</h1>
      <h1 className={style.animatedtext}>Playground</h1>
      <h1 className='max-w-2xl md:indent-8 text-xl md:text-2xl text-gray-700 text-center'>
